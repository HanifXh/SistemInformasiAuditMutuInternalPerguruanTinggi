...
<?php
    ...
    $query = mysqli_query($connect, "SELECT la.*,adt.* FROM login_auditor la INNER JOIN auditor adt ON adt.id_auditor = la.id_auditor WHERE username='$username_session'");
...
<head>
  ...
  <title>Audit Mutu STMIK Bandung | <?php echo $rows['nama_auditor']; ?></title>
        ...
        <ul class="nav navbar-nav">   
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../admin/pages/foto/auditor/<?php echo $rows['foto']; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $rows['nama_auditor']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="../admin/pages/foto/auditor/<?php echo $rows['foto']; ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo $rows['nama_auditor']; ?>
                  <small> Admin </small>
                </p>
              </li>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../koneksi/logout_auditor.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $rows['nama_auditor']; ?></p>
  ...
  <!--     <form action="#" method="get" class="sidebar-form">
    ...
    <!-- <li class="treeview">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index4.php?page=audit"><i class="glyphicon glyphicon-user"></i>Audit</a></li>
            <li><a href="index4.php?page=data_audit"><i class="glyphicon glyphicon-file"></i>Hasil Audit</a></li>
            <li><a href="index4.php?page=laporan"><i class="glyphicon glyphicon-save"></i>Laporan</a></li>
            <li><a href="index4.php?page=dokumen_auditor"><i class="glyphicon glyphicon-file"></i>Dokumen Pendukung</a></li>
        </li>
  ...
  if(isset($_GET['page'])){
    ...
    switch ($page) {
      ...
      case 'olah_akun_staf':
        ...
        break;
      case 'laporan':
        include "pages/evaluasi/laporan.php";
        break;
      case 'dokumen_auditor':
        include "pages/evaluasi/dokumen_auditor.php";
        break;
      case 'data_audit':
        include "pages/evaluasi/data_audit.php";
        break;
...
<script>
  $(document).ready(function() {
        $('#konfirmasi_hapus_audit').on('show.bs.modal', function(e) {
            $(this).find('.btn-ok').attr('href', $(e.relatedTarget).data('href'));
        });
    });
</script>
...
<script>
  $(document).ready(function(){
    $('#edit_modal_audit').on('show.bs.modal', function(e){
      var idx = $(e.relatedTarget).data('id')
      //menggunakan fungsi ajax untuk mengambil data
    $.ajax({
      type :'post',
      url  : 'pages/evaluasi/edit_modal_audit.php',
      data : 'idx='+ idx,
      success : function(data){
        $('.hasil-data').html(data); //menampilkan data ke dalam modal
      console.log(idx);
