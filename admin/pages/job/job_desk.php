...
$query = "SELECT max(kode_jobdesk) as maxKode FROM job_desk";
...
$char = "JBD";
$kd_jobdesk= $char . sprintf("%03s", $noUrut);
// echo $kodeBarang;
          ...
          <div class="box">
            ...
            <div class="row">
              <div class="col-xs-4" style="margin-left: 5px;">
                ...
                <i class="fa fa-plus"> </i> Tambah Deskripsi Pekerjaan
              ...
              <table id="example1" class="display nowrap table-responsive table-striped"  style="width:100%">
                ...
                ?>
                  <tr >
                      ...
                      <td> <?php echo $rows['kode_jobdesk']; ?></td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#edit_modal_jobdesk" data-toggle='modal' data-id="<?php echo $rows['kode_jobdesk'];?>" >Edit</a></li>
                    <li><a href="" data-toggle='modal' data-target='#konfirmasi_hapus_jobdesk' data-href="pages/config/delete_jobdesk.php?kode_jobdesk=<?php echo $rows['kode_jobdesk']; ?>"'>Delete</a></li>
...
<div class="modal fade" id="konfirmasi_hapus_jobdesk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
