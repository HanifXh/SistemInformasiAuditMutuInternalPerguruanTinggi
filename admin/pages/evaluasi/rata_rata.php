                ...
                ?>
                  <tr >
                      ...
                      <td><?php echo $rows['nama_auditor'];?></td>
                       <td><?php echo $rows['jumlah_butir_evaluasi_pada_kode_sop'];?></td>
                        <td><?php echo $rows['rata_rata_persentase'];?>%</td>
                         <td><?php echo $rows['ada'];?></td>
                          <td><?php echo $rows['tidak'];?></td>
