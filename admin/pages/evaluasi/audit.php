              ...
              <table id="example1" class="display nowrap table-responsive table-striped"  style="width:100%">
                ...
                ?>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#tambah_modal_audit" data-toggle='modal' data-id="<?php echo $rows['kode_butir']; ?>">Tambah</a></li>
                  </ul>
                </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Tambah Evaluasi Standar</h4>
            </div>
