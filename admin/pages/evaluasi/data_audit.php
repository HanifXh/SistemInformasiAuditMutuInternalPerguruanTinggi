           ...
           <th><center>Pengaturan Data</center></th>
                ...
                ?>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="#edit_modal_audit" data-toggle='modal' data-id="<?php echo $rows['id_evaluasi']; ?>" >Edit</a></li>
                    <li><a href="" data-toggle='modal' data-target='#konfirmasi_hapus_audit' data-href="pages/config/delete_evaluasi.php?id_evaluasi=<?php echo $rows['id_evaluasi']; ?>"'>Delete</a></li>
                </div>
...
<div class="modal fade" id="edit_modal_audit" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Edit Evaluasi Standar</h4>
            </div>
        <form action="pages/config/evaluasi_edit.php" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
